...
template <typename... fp_space_types>
void cuda_boundary<fp_type>::initialise(boundary_pair<fp_type, fp_space_types...> const &boundary, fp_type time,
                                        fp_space_types... space_args)
{
...
template <typename fp_type>
template <typename... fp_space_types>
void cuda_boundary<fp_type>::finalise(boundary_pair<fp_type, fp_space_types...> const &boundary, fp_type time,
                                      fp_space_types... space_args)
{
...
template <typename fp_type>
template <typename... fp_space_types>
const fp_type cuda_boundary<fp_type>::upper_boundary(boundary_pair<fp_type, fp_space_types...> const &boundary,
...
template <typename fp_type>
template <typename... fp_space_types>
const fp_type cuda_boundary<fp_type>::lower_boundary(boundary_pair<fp_type, fp_space_types...> const &boundary,
                                                     fp_type time, fp_space_types... space_args)
{
    fp_type ret{};
