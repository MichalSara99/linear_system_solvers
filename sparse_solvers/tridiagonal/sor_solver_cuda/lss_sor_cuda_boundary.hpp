...
template <typename fp_type> class sor_cuda_boundary
{
  private:
  ...
  public:
    ...
    explicit sor_cuda_boundary(const std::size_t discretization_size, const fp_type &space_step)
...
template <typename... fp_space_types>
void sor_cuda_boundary<fp_type>::initialise(boundary_pair<fp_type, fp_space_types...> const &boundary, fp_type time,
                                            fp_space_types... space_args)
{
...
template <typename fp_type>
template <typename... fp_space_types>
void sor_cuda_boundary<fp_type>::finalise(boundary_pair<fp_type, fp_space_types...> const &boundary, fp_type time,
                                          fp_space_types... space_args)
{
...
template <typename fp_type>
template <typename... fp_space_types>
const fp_type sor_cuda_boundary<fp_type>::upper_boundary(boundary_pair<fp_type, fp_space_types...> const &boundary,
...
template <typename fp_type>
template <typename... fp_space_types>
const fp_type sor_cuda_boundary<fp_type>::lower_boundary(boundary_pair<fp_type, fp_space_types...> const &boundary,
                                                         fp_type time, fp_space_types... space_args)
{
    fp_type ret{};
...
template <typename fp_type> using sor_cuda_boundary_ptr = sptr_t<sor_cuda_boundary<fp_type>>;
} // namespace lss_sor_solver_cuda
