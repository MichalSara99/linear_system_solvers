...
class sor_solver
{
  private:
    ...
    fp_type omega_;
    sor_boundary_ptr<fp_type> sor_boundary_;
    ...
    void initialize()
    {
        ...
        sor_boundary_ = std::make_shared<sor_boundary<fp_type>>(discretization_size_, step);
    }
  ...
  public:
    ...
    explicit sor_solver(std::size_t discretization_size) : discretization_size_{discretization_size}
    {
        initialize();
    }
