#pragma once
#if !defined(_LSS_TWO_DIM_PURE_HEAT_EQUATION_CUDA_T)
#define _LSS_TWO_DIM_PURE_HEAT_EQUATION_CUDA_T
...
#include "pde_solvers/two_dim/classic/lss_general_heat_equation_solvers_cuda.h"
...
template <typename T>
void test2DImplPureHeatEquationDirichletBCEulerDeviceCuda() {
  ...
  typedef general_heat_equation_cuda<
      T, boundary_condition_enum::Dirichlet, memory_space_enum::Device,
      real_sparse_solver_cuda, std::vector, std::allocator<T>>
      implicit_solver;
...
template <typename T>
void test2DImplPureHeatEquationDirichletBCCNDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::implicit_pde_schemes_enum;
  using lss_enumerations::memory_space_enum;
...
void test2DImplPureHeatEquationDirichletBCDeviceCuda() {
  std::cout << "============================================================\n";
  std::cout << "===== Implicit Pure Heat Equation CUDA (Dirichlet BC) ======\n";
  std::cout << "============================================================\n";

  test2DImplPureHeatEquationDirichletBCEulerDeviceCuda<double>();
  test2DImplPureHeatEquationDirichletBCEulerDeviceCuda<float>();
  test2DImplPureHeatEquationDirichletBCCNDeviceCuda<double>();
  test2DImplPureHeatEquationDirichletBCCNDeviceCuda<float>();
...
template <typename T>
void test2DImplPureHeatEquationNonHomDirichletBCEulerDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::implicit_pde_schemes_enum;
  using lss_enumerations::memory_space_enum;
...
template <typename T>
void test2DImplPureHeatEquationNonHomDirichletBCCNDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::implicit_pde_schemes_enum;
  using lss_enumerations::memory_space_enum;
...
void test2DImplPureHeatEquationNonHomDirichletBCDeviceCuda() {
  std::cout << "============================================================\n";
  std::cout << "== Implicit Pure Heat Equation CUDA (Non Hom Dirichlet BC) =\n";
  std::cout << "============================================================\n";

  test2DImplPureHeatEquationNonHomDirichletBCEulerDeviceCuda<double>();
  test2DImplPureHeatEquationNonHomDirichletBCEulerDeviceCuda<float>();
  test2DImplPureHeatEquationNonHomDirichletBCCNDeviceCuda<double>();
  test2DImplPureHeatEquationNonHomDirichletBCCNDeviceCuda<float>();
...
template <typename T>
void test2DImplNonHomPureHeatEquationDirichletBCEulerDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::implicit_pde_schemes_enum;
  using lss_enumerations::memory_space_enum;
...
template <typename T>
void test2DImplNonHomPureHeatEquationDirichletBCCNDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::implicit_pde_schemes_enum;
  using lss_enumerations::memory_space_enum;
...
void test2DImplNonHomPureHeatEquationDirichletBCDeviceCuda() {
  std::cout << "============================================================\n";
  std::cout << "= Implicit Non-Hom Pure Heat Equation CUDA (Dirichlet BC) ==\n";
  std::cout << "============================================================\n";

  test2DImplNonHomPureHeatEquationDirichletBCEulerDeviceCuda<double>();
  test2DImplNonHomPureHeatEquationDirichletBCEulerDeviceCuda<float>();
  test2DImplNonHomPureHeatEquationDirichletBCCNDeviceCuda<double>();
  test2DImplNonHomPureHeatEquationDirichletBCCNDeviceCuda<float>();
...
template <typename T>
void test2DExplPureHeatEquationDirichletBCEulerDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  ...
  std::cout << "============================================================\n";
  std::cout << "Solving Boundary-value Heat equation: \n\n";
  std::cout << " Using Euler on Device CUDA\n\n";
  std::cout << " Value type: " << typeid(T).name() << "\n\n";
  std::cout << " U_t(x,t) = U_xx(x,y,t) + U_yy(x,y,t), \n\n";
  std::cout << " where\n\n";
  std::cout << " x in <0,1>, y in <0,1> and t > 0,\n";
  ...
  typedef general_heat_equation_cuda<T, boundary_condition_enum::Dirichlet,
...
void test2DExplPureHeatEquationDirichletBCDeviceCuda() {
  std::cout << "============================================================\n";
  std::cout << "======== Explicit Pure Heat Equation (Dirichlet BC) ========\n";
  std::cout << "============================================================\n";

  test2DExplPureHeatEquationDirichletBCEulerDeviceCuda<double>();
  test2DExplPureHeatEquationDirichletBCEulerDeviceCuda<float>();
...
template <typename T>
void test2DExplPureHeatEquationNonHomDirichletBCEulerDeviceCuda() {
  using lss_containers::container_2d;
  using lss_enumerations::boundary_condition_enum;
  using lss_enumerations::explicit_pde_schemes_enum;
  using lss_two_dim_classic_pde_solvers::explicit_solvers::
  ...
  std::cout << "============================================================\n";
  std::cout << "Solving Boundary-value Heat equation: \n\n";
  std::cout << " Using Euler method on Device CUDA\n\n";
  std::cout << " Value type: " << typeid(T).name() << "\n\n";
  std::cout << " U_t(x,t) = U_xx(x,y,t) + U_yy(x,y,t), \n\n";
  std::cout << " where\n\n";
  std::cout << " x in <0,1>, y in <0,1> and t > 0,\n";
  ...
  auto initial_condition = [](T x, T y) { return 0.0; };
  // boundary conditions:
  auto const &dirichlet_x_low = [](T y, T t) { return 0.0; };     // up
  auto const &dirichlet_x_high = [](T y, T t) { return 0.0; };    // bottom
  auto const &dirichlet_y_low = [](T x, T t) { return 0.0; };     // left
  auto const &dirichlet_y_high = [](T x, T t) { return 100.0; };  // right
...
void test2DExplPureHeatEquationNonHomDirichletBCDeviceCuda() {
  std::cout << "============================================================\n";
  std::cout << "==== Explicit Pure Heat Equation (Non-Hom Dirichlet BC) ====\n";
  std::cout << "============================================================\n";

  test2DExplPureHeatEquationNonHomDirichletBCEulerDeviceCuda<double>();
  test2DExplPureHeatEquationNonHomDirichletBCEulerDeviceCuda<float>();

  std::cout << "============================================================\n";
}

#endif  ///_LSS_TWO_DIM_PURE_HEAT_EQUATION_CUDA_T
