...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Heat equation: \n\n"; std::cout << " Using CUDA
...
//    float var2{};
//    for (std::size_t i = 1; i <= n; ++i) {
//      var1 = std::pow(-1.0f, i + 1) * std::exp(-1.0f * (i * PI) * (i * PI) *
//      t); var2 = std::sin(i * PI * x) / i; sum += (var1 * var2);
//    }
//    return (first * sum);
//  };
//
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======== Explicit Pure Heat Equation (Dirichlet BC) ========\n";
//  std::cout <<
//  "============================================================\n";
//
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Heat equation with non-hom BC: \n\n"; std::cout
//  << " Using CUDA implicit Euler method\n\n"; std::cout << " Value type: " <<
//  typeid(double).name() << "\n\n"; std::cout << " U_t(x,t) = U_xx(x,t), \n\n";
//  std::cout << " where\n\n";
//  std::cout << " x in <0,1> and t > 0,\n";
//  std::cout << " U(0,t) = 0, U(1,t) = 100, t > 0 \n\n";
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Heat equation with non-hom BC: \n\n"; std::cout
//  << " Using CUDA solvers algorithm with implicit Euler method\n\n"; std::cout
//  << " Value type: " << typeid(float).name() << "\n\n"; std::cout << "
//  U_t(x,t) = U_xx(x,t), \n\n"; std::cout << " where\n\n"; std::cout << " x in
//  <0,1> and t > 0,\n"; std::cout << " U(0,t) = 0, U(1,t) = 100, t > 0 \n\n";
//  std::cout << " U(x,0) = x, x in <0,1> \n\n";
//  std::cout << " Exact solution: \n";
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======= Explicit Pure Heat Equation (with non-homogeneous \n"
//               "Dirichlet BC) ========\n";
//  std::cout <<
//  "============================================================\n";
//
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Heat equation with source: \n\n"; std::cout << "
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "== Explicit Pure Heat Equation with source (Dirichlet BC) ==\n";
//  std::cout <<
//  "============================================================\n";
//
...
//      double, BoundaryConditionType::Robin, std::vector,
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======== Explicit Pure Heat Equation (Robin BC) ============\n";
//  std::cout <<
//  "============================================================\n";
//
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Heat equation with heat source: \n\n"; std::cout
//  << " Using explicit Euler method\n\n"; std::cout << " Value type: " <<
//  typeid(float).name() << "\n\n"; std::cout << " U_t(x,t) = U_xx(x,t) + x,
//  \n\n"; std::cout << " where\n\n"; std::cout << " x in <0,1> and t > 0,\n";
//  std::cout << " U_x(0,t) = U_x(1,t) = 0, t > 0 \n\n";
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======= Explicit Pure Heat Equation with Source (with \n"
