#pragma once
#if !defined(_LSS_SOR_SOLVER_T)
#define _LSS_SOR_SOLVER_T

#include "common/lss_enumerations.h"
#include "common/lss_utility.h"
#include "sparse_solvers/lss_sor_solver.h"
...
template <typename T>
void testBVPDirichletBCSORTest() {
  using lss_sor_solver::flat_matrix;
  using lss_sor_solver::sor_solver;
