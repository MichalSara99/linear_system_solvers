...
void testSORCUDADirichletNeumannBC()
{
    std::cout << "==================================================\n";
    std::cout << "====== SOR CUDA solver (Dir-Neu BC) ==============\n";
    std::cout << "==================================================\n";

    testBVPSORCUDADirichletNeumannBC<double>();
    testBVPSORCUDADirichletNeumannBC<float>();
...
void testSORCUDANeumannDirichletBC()
{
    std::cout << "==================================================\n";
    std::cout << "========== SOR CUDA solver (Neu-Dir BC) ==========\n";
    std::cout << "==================================================\n";

    testBVPSORCUDANeumannDirichletBC<double>();
    testBVPSORCUDANeumannDirichletBC<float>();
...
void testSORCUDANeumannRobinBC()
{
    std::cout << "==================================================\n";
    std::cout << "========== SOR CUDA solver (Neu-Rob BC) ==========\n";
    std::cout << "==================================================\n";

    testBVPSORCUDANeumannRobinBC<double>();
    testBVPSORCUDANeumannRobinBC<float>();
