...
void testSORDirichletBC()
{
    std::cout << "==================================================\n";
    std::cout << "================ SOR (Dirichlet BC) ==============\n";
    std::cout << "==================================================\n";

    testBVPSORDirichletBC<double>();
    testBVPSORDirichletBC<float>();
...
void testSORRobinBC()
{
    ...
    testBVPSORRobinBC<double>();
    testBVPSORRobinBC<float>();
...
void testSORDirichletNeumannBC()
{
    std::cout << "==================================================\n";
    std::cout << "=========== SOR solver (Dir-Neu BC) ==============\n";
    std::cout << "==================================================\n";

    testBVPSORDirichletNeumannBC<double>();
    testBVPSORDirichletNeumannBC<float>();
...
void testSORNeumannDirichletBC()
{
    std::cout << "==================================================\n";
    std::cout << "========== SOR solver (Neu-Dir BC) ==============\n";
    std::cout << "==================================================\n";

    testBVPSORNeumannDirichletBC<double>();
    testBVPSORNeumannDirichletBC<float>();
...
void testSORMixBC()
{
    ...
    testBVPSORMixBC<double>();
    testBVPSORMixBC<float>();
