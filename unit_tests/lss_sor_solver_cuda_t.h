#pragma once
#if !defined(_LSS_SOR_SOLVER_CUDA_T)
#define _LSS_SOR_SOLVER_CUDA_T

#include "common/lss_enumerations.h"
#include "common/lss_utility.h"
#include "sparse_solvers/lss_sor_solver_cuda.h"

template <typename T>
void testSORSolverCUDA1() {
  using lss_sor_solver::flat_matrix;
  using lss_sor_solver::sor_solver_cuda;
  ...
  */
  ...
  std::vector<T> b = {static_cast<T>(6.), static_cast<T>(25.0),
                      static_cast<T>(-11.), static_cast<T>(15.)};

  // create sparse solver on DEVICE:
  sor_solver_cuda<T> sor(m);
...
template <typename T>
void testBVPDirichletBCSORCUDATest() {
  using lss_sor_solver::flat_matrix;
  using lss_sor_solver::sor_solver_cuda;
...
template <typename T>
void hostBVPRobinBCSORCUDATest() {
  using lss_sor_solver::flat_matrix;
  using lss_sor_solver::sor_solver_cuda;
...
void testBVPRobinBCSORCUDA() {
  std::cout << "============================================================\n";
  std::cout << "==================== BVP (Robin BC) ========================\n";
  std::cout << "============================================================\n";

  hostBVPRobinBCSORCUDATest<float>();
  hostBVPRobinBCSORCUDATest<double>();

  std::cout << "============================================================\n";
}

#endif  ///_LSS_SOR_SOLVER_CUDA_T
