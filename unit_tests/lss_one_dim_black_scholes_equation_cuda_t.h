...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using Thomas LU algorithm with implicit Euler method\n\n"; std::cout << "
//  Value type: " << typeid(T).name() << "\n\n"; std::cout << " U_t(x,t) =
//  0.5*sig*sig*x*x*U_xx(x,t) + r*x*U_x(x,t) - "
//               "r*U(x,t), \n\n";
//  std::cout << " where\n\n";
//  std::cout << " 0 < x < 20 and 0 < t < 1,\n";
//  std::cout << " U(0,t) = 0 and  U(20,t) = 20-K*exp(-r*(1-t)),0 < t < 1 \n\n";
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using Thomas LU algorithm with Crank-Nicolson method\n\n"; std::cout << "
//  Value type: " << typeid(T).name() << "\n\n"; std::cout << " U_t(x,t) =
//  0.5*sig*sig*x*x*U_xx(x,t) + r*x*U_x(x,t) - "
//               "r*U(x,t), \n\n";
//  std::cout << " where\n\n";
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======= Implicit Black-Scholes Equation (Dirichlet BC) =====\n";
//  std::cout <<
//  "============================================================\n";
//
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using Double Sweep algorithm with implicit Euler method\n\n"; std::cout << "
//  Value type: " << typeid(T).name() << "\n\n"; std::cout << " U_t(x,t) =
//  0.5*sig*sig*x*x*U_xx(x,t) + r*x*U_x(x,t) - "
//               "r*U(x,t), \n\n";
//  std::cout << " where\n\n";
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using Double Sweep algorithm with implicit Crank-Nicolson \n"
//               "method\n\n";
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "======== Implicit Balck-Scholes Equation (Dirichlet BC) ====\n";
//  std::cout <<
//  "============================================================\n";
//
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using explicit ADE Barakat Clark method\n\n"; std::cout << " Value type: "
//  << typeid(T).name() << "\n\n"; std::cout << " U_t(x,t) =
//  0.5*sig*sig*x*x*U_xx(x,t) + r*x*U_x(x,t) - "
//               "r*U(x,t), \n\n";
//  std::cout << " where\n\n";
...
//  "============================================================\n"; std::cout
//  << "Solving Boundary-value Black-Scholes equation: \n\n"; std::cout << "
//  Using explicit ADE Saulyev method\n\n"; std::cout << " Value type: " <<
//  typeid(T).name() << "\n\n"; std::cout << " U_t(x,t) =
//  0.5*sig*sig*x*x*U_xx(x,t) + r*x*U_x(x,t) - "
//               "r*U(x,t), \n\n";
//  std::cout << " where\n\n";
...
//  std::cout <<
//  "============================================================\n"; std::cout
//  << "====== Explicit Black-Scholes Equation (Dirichlet BC) ======\n";
//  std::cout <<
//  "============================================================\n";
//
