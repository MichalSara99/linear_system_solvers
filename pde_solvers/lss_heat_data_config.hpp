...
{
  private:
    std::function<fp_type(fp_type, fp_type, fp_type)> a_coeff_;
    std::function<fp_type(fp_type, fp_type, fp_type)> b_coeff_;
    std::function<fp_type(fp_type, fp_type, fp_type)> c_coeff_;
    std::function<fp_type(fp_type, fp_type, fp_type)> d_coeff_;
    std::function<fp_type(fp_type, fp_type, fp_type)> e_coeff_;
    std::function<fp_type(fp_type, fp_type, fp_type)> f_coeff_;
  ...
  public:
    explicit heat_coefficient_data_config(std::function<fp_type(fp_type, fp_type, fp_type)> const &a_coefficient,
