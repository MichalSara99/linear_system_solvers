...
#include "pde_solvers/one_dimensional/wave_type/implicit_coefficients/lss_wave_implicit_coefficients.hpp"
...
class implicit_wave_scheme
{
  ...
  public:
    static void rhs(wave_implicit_coefficients_ptr<fp_type> const &cfs, grid_config_1d_ptr<fp_type> const &grid_cfg,
    ...
    static void rhs_source(wave_implicit_coefficients_ptr<fp_type> const &cfs,
    ...
    static void rhs_initial(wave_implicit_coefficients_ptr<fp_type> const &cfs,
                            grid_config_1d_ptr<fp_type> const &grid_cfg, container_t const &input_0,
                            ...
                            fp_type const &time, container_t &solution)
    {
        ...
        if (auto const &ptr = std::dynamic_pointer_cast<neumann_boundary_1d<fp_type>>(second_bnd))
        {
            ...
            solution[N] = (two * (A(time, x) + B(time, x)) * input_0[N - 1]) +
                          (two * (lambda - C(time, x)) * input_0[N]) - (two * delta * B(time, x)) +
        ...
        for (std::size_t t = 1; t < N; ++t)
        {
            ...
            solution[t] = (two * B(time, x) * input_0[t + 1]) + (two * (lambda - C(time, x)) * input_0[t]) +
                          ...
                          (one_gamma * (D(time, x) + C(time, x)) * input_1[t]) -
                          (one_gamma * A(time, x) * input_1[t - 1]);
        }
    }

    static void rhs_initial_source(wave_implicit_coefficients_ptr<fp_type> const &cfs,
                                   grid_config_1d_ptr<fp_type> const &grid_cfg, container_t const &input_0,
                                   container_t const &input_1, container_t const &inhom_input,
                                   ...
                                   container_t &solution)
    {
        ...
        for (std::size_t t = 1; t < N; ++t)
        {
            ...
            solution[t] = (two * B(time, x) * input_0[t + 1]) + (two * (lambda - C(time, x)) * input_0[t]) +
                          (two * A(time, x) * input_0[t - 1]) - (one_gamma * B(time, x) * input_1[t + 1]) +
                          (one_gamma * (D(time, x) + C(time, x)) * input_1[t]) -
                          (one_gamma * A(time, x) * input_1[t - 1]) + inhom_input[t];
        }
    }

    static void rhs_terminal(wave_implicit_coefficients_ptr<fp_type> const &cfs,
                             grid_config_1d_ptr<fp_type> const &grid_cfg, container_t const &input_0,
                             container_t const &input_1, boundary_1d_pair<fp_type> const &boundary_pair,
                             fp_type const &time, container_t &solution)
    {
    ...
    static void rhs_terminal_source(wave_implicit_coefficients_ptr<fp_type> const &cfs,
                                    grid_config_1d_ptr<fp_type> const &grid_cfg, container_t const &input_0,
                                    container_t const &input_1, container_t const &inhom_input,
                                    boundary_1d_pair<fp_type> const &boundary_pair, fp_type const &time,
                                    container_t &solution)
...
class wave_implicit_solver_method
{
  ...
  private:
    ...
    solver solveru_ptr_;
    // scheme coefficients:
    wave_implicit_coefficients_ptr<fp_type> coefficients_;
    ...
    void split_0(fp_type time, container_t &low_0, container_t &diag_0, container_t &high_0)
    {
        fp_type x{};
    ...
    void split_1(fp_type time, container_t &low_1, container_t &diag_1, container_t &high_1)
    {
        fp_type x{};
  ...
  public:
    explicit wave_implicit_solver_method(solver const &solver_ptr,
                                         wave_implicit_coefficients_ptr<fp_type> const &coefficients,
