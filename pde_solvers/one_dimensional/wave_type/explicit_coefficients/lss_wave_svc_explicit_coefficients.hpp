...
template <typename fp_type> struct wave_svc_explicit_coefficients
{
  ...
  public:
    ...
    explicit wave_svc_explicit_coefficients(wave_data_config_1d_ptr<fp_type> const &wave_data_config,
    ...
    {
        return [=](fp_type x, fp_type t) -> fp_type { return wave_source(x, t) / E_(x); };
    }
};
