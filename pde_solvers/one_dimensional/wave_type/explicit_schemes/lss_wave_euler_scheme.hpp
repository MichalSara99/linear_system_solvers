...
/**
 * wave_euler_time_loop object
 */
template <typename fp_type, template <typename, typename> typename container, typename allocator>
class wave_euler_time_loop
{
...
template <typename fp_type, template <typename, typename> typename container, typename allocator>
template <typename solver>
void wave_euler_time_loop<fp_type, container, allocator>::run(
...
template <typename fp_type, template <typename, typename> typename container, typename allocator>
template <typename solver>
void wave_euler_time_loop<fp_type, container, allocator>::run_with_stepping(
    solver const &solver_ptr, boundary_1d_pair<fp_type> const &boundary_pair, range<fp_type> const &time_range,
    std::size_t const &last_time_idx, fp_type const time_step, traverse_direction_enum const &traverse_dir,
...
{
    typedef wave_euler_time_loop<fp_type, container, allocator> loop;
  ...
  public:
    wave_euler_scheme(wave_explicit_coefficients_ptr<fp_type> const &coefficients,
