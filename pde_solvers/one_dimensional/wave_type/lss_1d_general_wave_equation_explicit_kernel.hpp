#if !defined(_LSS_1D_GENERAL_WAVE_EQUATION_EXPLICIT_KERNEL_HPP_)
#define _LSS_1D_GENERAL_WAVE_EQUATION_EXPLICIT_KERNEL_HPP_
...
class general_wave_equation_explicit_kernel
{
};
...
class general_wave_equation_explicit_kernel<memory_space_enum::Device, fp_type, container, allocator>
{
  ...
  public:
    general_wave_equation_explicit_kernel(boundary_1d_pair<fp_type> const &boundary_pair,
                    ...
                    bool is_wave_sourse_set, std::function<fp_type(fp_type, fp_type)> const &wave_source)
    {
        ...
        auto wave_coeff_holder =
            std::make_shared<wave_explicit_coefficients<fp_type>>(wave_data_cfg_, discretization_cfg_);
        ...
        typedef wave_euler_cuda_scheme<fp_type, container, allocator> euler_cuda_scheme_t;
...
template <typename fp_type, template <typename, typename> typename container, typename allocator>
class general_wave_equation_explicit_kernel<memory_space_enum::Host, fp_type, container, allocator>
{
    typedef discretization<dimension_enum::One, fp_type, container, allocator> d_1d;
    typedef container<fp_type, allocator> container_t;
  ...
  public:
                    ...
                    bool is_wave_sourse_set, std::function<fp_type(fp_type, fp_type)> const &wave_source)
    {
        ...
        typedef wave_euler_scheme<fp_type, container, allocator> euler_scheme_t;
...
#endif ///_LSS_1D_GENERAL_WAVE_EQUATION_EXPLICIT_KERNEL_HPP_
