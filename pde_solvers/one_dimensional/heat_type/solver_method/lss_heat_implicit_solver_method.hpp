...
class implicit_heat_scheme
{
  ...
  public:
    static void rhs(general_heat_equation_coefficients_ptr<fp_type> const &cfs,
    ...
    static void rhs_source(general_heat_equation_coefficients_ptr<fp_type> const &cfs,
                           grid_config_1d_ptr<fp_type> const &grid_cfg, container_t const &input,
...
class heat_implicit_solver_method
{
  ...
  private:
    ...
    solver solveru_ptr_;
    // scheme coefficients:
    general_heat_equation_coefficients_ptr<fp_type> coefficients_;
    ...
    void split(fp_type const &time, container_t &low, container_t &diag, container_t &high)
    {
        fp_type x{};
  ...
  public:
    explicit heat_implicit_solver_method(solver const &solver_ptr,
                                         general_heat_equation_coefficients_ptr<fp_type> const &coefficients,
