...
template <typename fp_type> struct heat_barakat_clark_coefficients
{
  public:
    // scheme coefficients:
    fp_type k_;
  ...
  public:
    ...
    explicit heat_barakat_clark_coefficients(general_heat_equation_coefficients_ptr<fp_type> const &coefficients)
    {
...
using heat_barakat_clark_coefficients_ptr = sptr_t<heat_barakat_clark_coefficients<fp_type>>;
