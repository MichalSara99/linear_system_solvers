#if !defined(_LSS_HEAT_BARAKAT_CLARK_SVC_COEFFICIENTS_HPP_)
#define _LSS_HEAT_BARAKAT_CLARK_SVC_COEFFICIENTS_HPP_
...
template <typename fp_type> struct heat_barakat_clark_svc_coefficients
{
  public:
    // scheme coefficients:
    fp_type h_, k_;
  ...
  public:
    heat_barakat_clark_svc_coefficients() = delete;

    explicit heat_barakat_clark_svc_coefficients(
...
using heat_barakat_clark_svc_coefficients_ptr = sptr_t<heat_barakat_clark_svc_coefficients<fp_type>>;

} // namespace one_dimensional

} // namespace lss_pde_solvers

#endif ///_LSS_HEAT_BARAKAT_CLARK_SVC_COEFFICIENTS_HPP_
