#pragma once
#if !defined(_LSS_1D_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA)
#define _LSS_1D_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA
...
// ============================================================================
// ======= general_heat_equation_cuda Dirichlet Specialisation Template =======
// ============================================================================
/*!
   ============================================================================
...
// ============================================================================
// === explicit_general_heat_equation_cuda Dirichlet Specialisation Template ==
// ============================================================================
/*!
   ============================================================================
   Represents implicit solver for general Dirichlet 1D heat equation
...
void implicit_solvers::general_heat_equation_cuda<
  ...
  d1d_t::discretize_space(h, (space_range.lower() + h), prev_sol);
  ...
  solution[0] = boundaryPtr_->first(last_time);
  std::copy(prev_sol.begin(), prev_sol.end(), std::next(solution.begin()));
  solution[solution.size() - 1] = boundaryPtr_->second(last_time);
}
...
#endif  ///_LSS_1D_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA
