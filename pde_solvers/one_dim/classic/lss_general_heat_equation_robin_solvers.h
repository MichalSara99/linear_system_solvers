#pragma once
#if !defined(_LSS_1D_GENERAL_HEAT_EQUATION_ROBIN_SOLVERS)
#define _LSS_1D_GENERAL_HEAT_EQUATION_ROBIN_SOLVERS
...
#endif  //_LSS_1D_GENERAL_HEAT_EQUATION_ROBIN_SOLVERS
