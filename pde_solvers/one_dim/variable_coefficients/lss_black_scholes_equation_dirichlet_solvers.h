#pragma once
#if !defined(_LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS)
#define _LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS
...
#include "lss_black_scholes_equation_solvers_base.h"
...
void explicit_solvers::black_scholes_equation<
  ...
  d_1d::discretize_initial_condition(dataPtr_->terminal_condition,
                                     init_condition);
  // get the correct scheme:
  if (scheme == explicit_pde_schemes_enum::Euler) {
    lss_one_dim_space_variable_heat_explicit_schemes::heat_euler_scheme<
        ...
        heat_euler_scheme_backward_policy<
            fp_type, pde_coefficient_holder_fun_1_arg<fp_type>, container,
            alloc>>
...
#endif  //_LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS
