#pragma once
#if !defined( \
    _LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA)
#define _LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA
...
/*!
   ============================================================================
   Represents general spacial variable 1D heat equation Dirichlet solvers
   on CUDA
...
#endif  ///_LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_DIRICHLET_SOLVERS_CUDA
