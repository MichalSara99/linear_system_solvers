#pragma once
#if !defined(_LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_BASE)
#define _LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_BASE
...
#endif  //_LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_BASE
