#pragma once
#if !defined(_LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS_CUDA)
#define _LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS_CUDA
...
/*!
  ...
  Represents general implicit 1D Black-Scholes Dirichlet solver on CUDA
...
class black_scholes_equation_cuda<fp_type, boundary_condition_enum::Dirichlet,
 ...
 public:
  ...
  explicit black_scholes_equation_cuda() = delete;
  explicit black_scholes_equation_cuda(range<fp_type> const &space_range,
  ...
  ~black_scholes_equation_cuda() {}

  black_scholes_equation_cuda(black_scholes_equation_cuda const &) = delete;
  black_scholes_equation_cuda(black_scholes_equation_cuda &&) = delete;
  black_scholes_equation_cuda &operator=(black_scholes_equation_cuda const &) =
      delete;
  black_scholes_equation_cuda &operator=(black_scholes_equation_cuda &&) =
      delete;
...
Represents general explicit 1D Black-Scholes Dirichlet solver on CUDA
...
template <typename fp_type, memory_space_enum memory_space,
          ...
          typename real_sparse_policy_cuda,
          template <typename, typename> typename container, typename alloc>
void implicit_solvers::black_scholes_equation_cuda<
...
// ============================================================================
// ========= black_scholes_equation_cuda (Dirichlet BC) implementation ========
// ============================================================================

template <typename fp_type, template <typename, typename> typename container,
          typename alloc>
bool explicit_solvers::black_scholes_equation_cuda<
...
template <typename fp_type, template <typename, typename> typename container,
          typename alloc>
void explicit_solvers::black_scholes_equation_cuda<
...
#endif  ///_LSS_BLACK_SCHOLES_EQUATION_DIRICHLET_SOLVERS_CUDA
