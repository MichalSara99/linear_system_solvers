#pragma once
#if !defined(_LSS_SPACE_VARIABLE_HEAT_EXPLICIT_SCHEMES_POLICY)
#define _LSS_SPACE_VARIABLE_HEAT_EXPLICIT_SCHEMES_POLICY
...
#endif  //_LSS_SPACE_VARIABLE_HEAT_EXPLICIT_SCHEMES_POLICY
