#pragma once
#if !defined(_LSS_BLACK_SCHOLES_EQUATION_ROBIN_SOLVERS_CUDA)
#define _LSS_BLACK_SCHOLES_EQUATION_ROBIN_SOLVERS_CUDA
...
// ============================================================================
// ==== black_scholes_equation_cuda Robin Specialisation Template =============
// ============================================================================
/*!
   ============================================================================
   Represents general implicit 1D Black-Scholes Robin solver on CUDA
...
class black_scholes_equation_cuda<fp_type, boundary_condition_enum::Robin,
...
#endif  ///_LSS_BLACK_SCHOLES_EQUATION_ROBIN_SOLVERS_CUDA
