#pragma once
#if !defined(_LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_CUDA)
#define _LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_CUDA
...
#endif  ///_LSS_1D_SPACE_VARIABLE_GENERAL_HEAT_EQUATION_SOLVERS_CUDA
