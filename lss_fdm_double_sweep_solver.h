...
namespace lss_fdm_double_sweep_solver {
	...
	template<typename T,
		...
		typename Alloc>
		class FDMDoubleSweepSolver :public FDMDoubleSweepSolverBase<T, Container, Alloc> {
		protected:
	...
	template<typename T,
		template<typename T, typename Allocator> typename Container,
		typename Alloc>
		class FDMDoubleSweepSolver<T, BoundaryConditionType::Dirichlet, Container, Alloc>
		...
		public:
			...
			inline void setBoundaryCondition(std::pair<T, T> const &boundaryPair) { boundary_ = boundaryPair; }
...
template<typename T,
	template<typename T, typename Alloc> typename Container,
	typename Alloc>
	Container<T, Alloc> const lss_fdm_double_sweep_solver::FDMDoubleSweepSolverBase<T, Container, Alloc>::
	solve() {
...
template<typename T,
	template<typename T, typename Alloc> typename Container,
	typename Alloc>
	void lss_fdm_double_sweep_solver::FDMDoubleSweepSolver<T, lss_types::BoundaryConditionType::Dirichlet, Container, Alloc>::
...
template<typename T,
	template<typename T, typename Alloc> typename Container,
	typename Alloc>
	void lss_fdm_double_sweep_solver::FDMDoubleSweepSolver<T, lss_types::BoundaryConditionType::Robin, Container, Alloc>::
	kernel(Container<T, Alloc>& solution) {
	// clear coefficients:
	K_.clear();
	L_.clear();
